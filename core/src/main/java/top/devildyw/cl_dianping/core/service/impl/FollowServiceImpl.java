...
import top.devildyw.cl_dianping.core.mapper.FollowMapper;
...
import static top.devildyw.cl_dianping.common.constants.RedisConstants.FOLLOW_KEY;
...
public class FollowServiceImpl extends ServiceImpl<FollowMapper, Follow> implements IFollowService {
    ...
    @Override
    public List<Long> getUserIdsByFollowUserId(Long followUserId) {
        return baseMapper.selectUserIdsByFollowUserId(followUserId);
    }
}
